  ...
  return (
    ...
    >
      <div className={styles.healthContainer}>
        <div
          className={`${styles.healthBar__outer} ${
            props.player.role === 1 && styles.healthBar__outer__enemy
          }`}
          style={{ width: `${props.width}px` }}
        >
          <div
            className={styles.healthBar__inner}
            style={{ width: `${healthRatio}px` }}
          ></div>
        </div>

        <div className={`${props.player.role === 2 && styles.flexBox}`}>
          <div
            className={`${styles.wrappingProfile} ${
              props.player.role === 2 && styles.flexReverse
            }`}
          >
            <Avatar
